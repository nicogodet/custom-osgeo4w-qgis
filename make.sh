...
sed -i "s/qgis-isl-VERSION=.*/qgis-isl-VERSION=$VERSION/" apps/qgis-isl/qgis-ltr-isl.bat.template

# compression
tar cvjSf ../qgis-isl-$VERSION.tar.bz2 .

# restores @@ marker  
sed -i "s/qgis-isl-VERSION=.*/qgis-isl-VERSION=@@/" apps/qgis-isl/qgis-ltr-isl.bat.template
